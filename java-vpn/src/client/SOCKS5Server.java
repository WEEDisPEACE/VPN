...
public class SOCKS5Server {
    ...
    private void handleClient(Socket clientSocket) {
        try (InputStream in = clientSocket.getInputStream();
            ...
            // Step 3: Proxy data through VPN tunnel
            proxyData(clientSocket, in, out, connInfo);
    ...
    /**
     * Proxy data between client and VPN tunnel
     */
    private void proxyData(Socket clientSocket, InputStream in, OutputStream out, ConnectionInfo connInfo) {
        try {
            ...
            while ((bytesRead = in.read(buffer)) != -1) {
                ...
                byte[] response = vpnClient.sendThroughTunnel(connInfo.host, connInfo.port, dataToSend);
            ...
            VPNLogger.debug("Proxy connection closed: " + e.getMessage());
        }
    }
